...
#else
  #define LOGGER_LOG_LEVEL LOGGER_LEVEL_NONE
#endif
...
void logPrintf(Stream& stream, const char* fmt, ...);
  ...
  #define LOG_DEFINE_MODULE(name) static const char* LOG_TAG = name;
    ...
    #define LOG_E(fmt, ...)                                                     \
        do {                                                                    \
            logPrintf(LOGGER_PRINT, "[%6lu][E]" LOG_FMT, LOGGER_TIME, LOG_FNL); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                   \
        } while (0)
    #define LOG_E_MOD(fmt, ...)                                                  \
        do {                                                                     \
            logPrintf(LOGGER_PRINT, "[%6lu][E]" LOG_MFMT, LOGGER_TIME, LOG_TAG); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                    \
        } while (0)
  #endif
    ...
    #define LOG_W(fmt, ...)                                                     \
        do {                                                                    \
            logPrintf(LOGGER_PRINT, "[%6lu][W]" LOG_FMT, LOGGER_TIME, LOG_FNL); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                   \
        } while (0)
    #define LOG_W_MOD(fmt, ...)                                                  \
        do {                                                                     \
            logPrintf(LOGGER_PRINT, "[%6lu][W]" LOG_MFMT, LOGGER_TIME, LOG_TAG); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                    \
        } while (0)
  #endif
    ...
    #define LOG_I(fmt, ...)                                                     \
        do {                                                                    \
            logPrintf(LOGGER_PRINT, "[%6lu][I]" LOG_FMT, LOGGER_TIME, LOG_FNL); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                   \
        } while (0)
    #define LOG_I_MOD(fmt, ...)                                                  \
        do {                                                                     \
            logPrintf(LOGGER_PRINT, "[%6lu][I]" LOG_MFMT, LOGGER_TIME, LOG_TAG); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                    \
        } while (0)
  #endif
    ...
    #define LOG_D(fmt, ...)                                                     \
        do {                                                                    \
            logPrintf(LOGGER_PRINT, "[%6lu][D]" LOG_FMT, LOGGER_TIME, LOG_FNL); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                   \
        } while (0)
    #define LOG_D_MOD(fmt, ...)                                                  \
        do {                                                                     \
            logPrintf(LOGGER_PRINT, "[%6lu][D]" LOG_MFMT, LOGGER_TIME, LOG_TAG); \
            logPrintf(LOGGER_PRINT, fmt "\n", ##__VA_ARGS__);                    \
        } while (0)
  #endif
