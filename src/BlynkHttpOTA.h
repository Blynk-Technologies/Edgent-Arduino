...
static bool parseURL(String url, String& protocol, String& host, int& port, String& path) {
...
static bool downloadUpgradeHTTP(HttpClient& http) {
...
static bool downloadUpgrade(const String& url) {
